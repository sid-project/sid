...
static int _multipath_component_scan_pre(const struct sid_ubridge_cmd_context *cmd)
{
...
static int _multipath_component_error(const struct sid_ubridge_cmd_context *cmd)
{
	log_debug(ID, "error");
	return 0;
}
