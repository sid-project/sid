...
static int _dummy_block_scan_pre(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
...
static int _dummy_block_scan_current(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
...
static int _dummy_block_scan_next(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
...
static int _dummy_block_scan_post_current(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
...
static int _dummy_block_scan_post_next(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
...
static int _dummy_block_trigger_action_current(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
...
static int _dummy_block_trigger_action_next(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
...
static int _dummy_block_error(struct sid_module *module, struct sid_ubridge_cmd_context *cmd)
{
	log_debug(ID, "error");
	return 0;
}
