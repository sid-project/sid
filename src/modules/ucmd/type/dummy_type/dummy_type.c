...
static int _dummy_type_init(struct module *module, struct sid_ucmd_common_ctx *ucmd_common_ctx)
{
	log_debug(MID, "init");
	return 0;
}
...
static int _dummy_type_exit(struct module *module, struct sid_ucmd_common_ctx *ucmd_common_ctx)
{
	log_debug(MID, "exit");
	return 0;
}
...
static int _dummy_type_reset(struct module *module, struct sid_ucmd_common_ctx *ucmd_common_ctx)
{
	log_debug(MID, "reset");
	return 0;
}
