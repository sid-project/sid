...
#define list_iterate_back(v, head) \
...
#define list_iterate_items_gen_safe_back(v, t, head, field) \
	for (v = list_struct_base((head)->p, __typeof__(*v), field), \
	     t = list_struct_base(v->field.p, __typeof__(*v), field); \
	     &v->field != (head); \
	     v = t, t = list_struct_base(v->field.p, __typeof__(*v), field))

#define list_iterate_items_safe_back(v, t, head) \
	list_iterate_items_gen_safe_back(v, t, (head), list)
