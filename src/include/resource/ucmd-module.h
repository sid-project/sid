...
typedef enum {
	...
	KV_PERSISTENT      = UINT64_C(0x0000000000000002),
	...
	KV_MOD_RD          = UINT64_C(0x0000000000000010),
	KV_SUBMOD_RD       = UINT64_C(0x0000000000000020),
	KV_RD              = UINT64_C(0x0000000000000030),

	KV_MOD_WR          = UINT64_C(0x00000000000000040),
